...
import cns.body.followfunction.YoutubeResultListViewAdapter
...
class YouTubeResult : androidx.fragment.app.Fragment() {
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        mListener!!.listState = result_list.layoutManager!!.onSaveInstanceState()
        outState.putString("sendquery", mListener!!.sendquery!!)
        outState.putParcelable(LIST_STATE_KEY, mListener!!.listState)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adapter = YoutubeResultListViewAdapter(
            mListener!!.data,
            context!!
        ) { s: String ->
    ...
    override fun onResume() {
        super.onResume()
        if (mListener!!.listState != null) {
            result_list.layoutManager!!.onRestoreInstanceState(mListener!!.listState)
        }
    }
